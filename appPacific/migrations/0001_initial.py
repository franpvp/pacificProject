    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_metodo_pago', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appPacific.metodopago', verbose_name='Método de Pago cliente')),
                ('tipo_hab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appPacific.tipohabitacion', verbose_name='Tipo Habitación')),
            ],
        ),
        migrations.CreateModel(
            name='ReporteReserva',
