...
class MetodoPago(models.Model):
    ...
    def __str__(self):
        return str(self.id_metodo_pago)
...
class TipoHabitacion(models.Model):
    ...
    def __str__(self):
        return str(self.id_tipo_hab)

# Tabla Habitaciones
class Habitacion(models.Model):
    id_hab = models.AutoField(primary_key=True, unique=True, verbose_name="Id habitación")
    id_tipo_hab = models.ForeignKey(TipoHabitacion, on_delete=models.CASCADE, verbose_name="ID tipo habitación")
...
class ReporteReserva(models.Model):
    id_reporte = models.AutoField(primary_key=True, unique=True, verbose_name="ID reporte")
